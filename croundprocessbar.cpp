...
CRoundProcessBar::CRoundProcessBar(QWidget *parent)
: QProgressBar(parent)
{
...
CRoundProcessBar::~CRoundProcessBar()
{

}

void CRoundProcessBar::setScanValue(QString strValue)
{
    m_strValue = strValue;
    this->repaint();
}

void CRoundProcessBar::resetVariables(QPainter *painter)
{
    m_outerRadius=width()>height() ? height()/2 : width()/2;
    m_innerRadius=0.8*m_outerRadius;
    m_center=rect().center();
...
void CRoundProcessBar::paintEvent(QPaintEvent *event)
{
    QPainter painter;
    painter.begin(this);
...
void CRoundProcessBar::drawOuterCircle(QPainter* painter)
{
    painter->save();
...
void CRoundProcessBar::drawInnerCircle(QPainter* painter)
{
    painter->save();
...
void CRoundProcessBar::drawColorPies(QPainter* painter, QString strValue)
{
    painter->save();
    painter->setPen(Qt::NoPen);
...
void CRoundProcessBar::drawGraph(QPainter* painter)
{
...
void CRoundProcessBar::drawTextRect(QPainter* painter)
{
    painter->save();
